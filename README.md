...
> 按 GitHub Stars 数量排序，数据来源 GitHub API (2026-03-17)

| 排名 | 项目 | Stars | 描述 | 分类 |
|------|------|-------|------|------|
| 🥇 | **OpenClaw 官方** | ⭐ 317,621 | 官方仓库，AI Agent 框架 TOP 1 | 官方 |
| 🥈 | **awesome-openclaw-skills** | ⭐ 38,399 | OpenClaw 技能精选集，5400+ 技能 | 工具与技能 |
| 🥉 | **AIRI** | ⭐ 34,070 | 虚拟偶像伴侣，实时语音聊天 | AI 伴侣 |
| 4 | **nanobot (HKUDS)** | ⭐ 34,029 | Ultra-Lightweight OpenClaw，超轻量级 | 核心变种 |
| 5 | **ZeroClaw** | ⭐ 27,469 | Fast, small, and fully autonomous AI assistant | 核心变种 |
| 6 | **AstrBot** | ⭐ 25,291 | Agentic IM Chatbot基础设施，多平台LLM机器人 | 中国特色 |
| 7 | **NanoClaw** | ⭐ 23,566 | 轻量级替代方案，容器化运行 | 核心变种 |
| 8 | **LangBot** | ⭐ 15,594 | 生产级多平台智能机器人开发平台 | 中国特色 |
| 9 | **memU** | ⭐ 12,969 | 24/7 主动 Agent 记忆系统 | 记忆系统 |
| 10 | **MoltWorker** | ⭐ 9,644 | Cloudflare Workers 无服务器运行 | 核心变种 |
| 11 | **Edict** | ⭐ 10,111 | 三省六部制·OpenClaw多Agent编排系统 | 工具与仪表板 |
| 12 | **ClawHub** | ⭐ 6,112 | OpenClaw 官方技能目录 | 工具与技能 |
| 13 | **MemOS** | ⭐ 7,229 | 记忆操作系统 | 记忆系统 |
| 14 | **ClawX** | ⭐ 4,655 | 桌面客户端 | 工具与仪表板 |
| 15 | **OpenClaw-RL** | ⭐ 3,214 | 通过对话训练 agent 的强化学习框架 | 垂直领域 |
| 16 | **OpenClaw Mission Control** | ⭐ 2,580 | AI Agent 编排仪表板 | 工具与仪表板 |
| 17 | **Antfarm** | ⭐ 2,167 | 一命令构建 Agent 团队 | 工具与仪表板 |
| 18 | **PUAClaw** | ⭐ 1,800 | Claw 们终将接管世界 | 趣味变种 |
| 19 | **Clawith** | ⭐ 800 | OpenClaw for Teams | 团队协作 |
...
**支持平台**
- Telegram, Slack, Discord, WhatsApp, Feishu, QQ, Email, Matrix 等
...
> 国内至少有 10 款以上 OpenClaw 平替产品，可以分成两类：**本地型**和**云端型**。

#### 本地型特点
Agent 运行在你的电脑上，权限大、能操作本地文件和软件，能力强，但安全风险也高。

#### 云端型特点
Agent 跑在远程服务器上，更安全、也能 7×24 在线，但碰不到你的本地电脑，能力受限制。
...
- **最大特点**：容易上手
- 下载安装就能用，快速对接飞书，还能一键迁移旧配置。它更像是 OpenClaw 的「傻瓜版」。
- **适合人群**：第一次接触 Agent、怕折腾、又主要在飞书里工作的人
...
- **最大特点**：纯自研，面向企业的产品
- 不仅支持 QQ、飞书、钉钉、微信，还做了高危操作拦截、安全审计、权限范围限制这些能力
- **适合人群**：团队、公司，以及对安全合规要求更高的人
...
- **官网**：https://agent.minimaxi.com/max-claw
- **最大特点**：便宜、省心、预设多
- 通过多种专家预设，把 Agent 做成一个更容易理解的服务。39 元包月，对普通用户来说门槛很低
- **适合人群**：预算有限、不想折腾部署、只想快速体验 Agent 能力的人

###### 4.5 字节 ArkClaw

- **官网**：https://www.volcengine.com/
- **最大特点**：深度适配飞书
- 能处理飞书文档、多维表格和日程，这意味着它更像一个直接嵌入协作场景的助手
- **适合人群**：重度飞书用户，尤其是内容、运营、行政这类每天都在飞书里工作的人

###### 4.6 字节飞书秒搭

- **官网**：https://miaoda.feishu.cn/bot
- **最大特点**：一键安装+打通飞书
- 这是目前体验过安装最简单的 OpenClaw 类产品，全程零操作，开箱即用，连飞书机器人都自动配好
- **适合人群**：纯小白，属于开箱即用的最佳代表

---

###### 选型建议

> 如果要我选，我还是倾向于本地部署，可能我比较技术流，喜欢完全的掌控感和数据私有属性。当然，这也是最不适合普通人的方案。
>
> 关键是，你既然要养它，那就思考如何才能把它培养成一只优秀的龙虾。以后比拼的不是谁有龙虾，而是谁有能替自己干活的 AI 员工。没有最好的龙虾，只有最适合你的那只。
...
**简介**
Agentic IM Chatbot 基础设施，集成多个 IM 平台、LLM、插件和 AI 功能，可作为 OpenClaw 替代品。支持 Discord / Slack / LINE / Telegram / WeChat / 飞书 / 钉钉 / QQ 等。

**✅ 优点**
- 支持 10+ 平台
- 集成 DeepSeek, Claude, Gemini, Ollama 等
- 插件系统
- Python 实现，易于二次开发
...
| 项目 | Stars | 特点 |
|------|-------|------|
| AIRI ⭐33,057 | 虚拟偶像伴侣 | 实时语音聊天、游戏集成 |
| AstrBot ⭐22,964 | Agentic IM | 多平台 LLM 机器人 |
| ClawHub ⭐5,658 | 技能市场 | 官方认证技能目录 |
...
| 分类 | 项目数 | 最高 Stars |
|------|--------|------------|
| 官方里程碑 | 1 | 317,621 (OpenClaw 官方) |
| 热门变种 | 19 | 38,399 (awesome-openclaw-skills) |
| 核心变种 | 4 | 34,029 (nanobot) |
| 中国特色 | 3 | 25,291 (AstrBot) |
| AutoClaw 系列 | 5 | 40 |
| 垂直领域 | 3 | 3,214 (OpenClaw-RL) |
| 工具仪表板 | 7 | 12,969 (memU) |
| 记忆系统 | 3 | 12,969 (memU) |
...
*🦞 Last updated: 2026-03-17 | ClawDen - OpenClaw 变种收集站*
